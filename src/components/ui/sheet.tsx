...
const sheetVariants = cva(
  "fixed z-50 flex flex-col gap-0 bg-popover text-sm text-popover-foreground ring-1 ring-foreground/10 outline-none duration-200 data-open:animate-in data-closed:animate-out",
  {
    variants: {
      side: {
        right:
          "inset-y-0 right-0 h-full w-full border-l data-closed:slide-out-to-right data-open:slide-in-from-right sm:max-w-lg",
        left: "inset-y-0 left-0 h-full w-full border-r data-closed:slide-out-to-left data-open:slide-in-from-left sm:max-w-lg",
